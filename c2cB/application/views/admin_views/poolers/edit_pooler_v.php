...
<section class="content-header">
    <h1>
        Pooler
        <small>Edit Pooler </small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li> 
        <li><a href="<?php echo base_url('admin/pooler'); ?>"><i class="fa fa-cogs"></i> Manage Pooler</a></li>
        <li class="active"><i class="fa fa-circle-o"></i> Edit Pooler </li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Pooler </h3>
        ...
        <!-- form start -->
        <form role="form" name="edit_form" action="<?php echo base_url('admin/pooler/update_pooler/' . $user_data['Id'] . ''); ?>" method="post" class="form-validation" >
            ...
            <div class="box-footer">
                <a href="<?php echo base_url('admin/pooler'); ?>" class="btn btn-danger" data-toggle="tooltip" title="Go back"><i class="fa fa-remove"></i> Cancel</a>
