...
<section class="content-header">
    <h1>
        Pooler
        <small>Add Pooler</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li> 
        <li><a href="<?php echo base_url('admin/pooler'); ?>"><i class="fa fa-cogs"></i> Manage Poolers</a></li>
        <li><a class="active"><i class="fa fa-cogs"></i> Add Pooler</a></li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Add Pooler</h3>
        ...
        <!-- form start -->
        <form role="form" name="add_form" action="<?php echo base_url('admin/pooler/create_pooler'); ?>" method="post"  class="form-validation" >
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
