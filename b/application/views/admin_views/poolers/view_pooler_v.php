...
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">View Pooler </h3>
    ...
    <div class="row">
        <div class="col-md-12">
                <div class="col-lg-2 col-md-3">
                    <img src="<?php echo base_url() ?>/assets/backend/img/pooler/<?php echo $user_data['Image'] ?>" class="img-responsive img-thumbnail">
                </div>
