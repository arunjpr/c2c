    ...
    <div class="quick-actions_homepage">
      ...
      <ul class="quick-actions">
       <!--
		...
		<?php $product_count = mysqli_num_rows(mysqli_query($conn,"select * from product where status='1'"));if($product_count > 0)	{?>
        <span class="label label-important"><?php echo $product_count;?></span>  Total Product <?php } ?></a> </li>	
          
        <li class="bg_ly"> <a href="manage_customer.php"> <i class="icon-user"></i>
		<?php $cus_count = mysqli_num_rows(mysqli_query($conn,"select * from customer where status='1'"));if($cus_count > 0)	{?>
	    ...
	    <?php $order_count = mysqli_num_rows(mysqli_query($conn,"select * from `order` where order_status='1' group by order_id"));if($order_count > 0)	{?>
		...
		<span class="label label-important">Rs : <?php $payment = mysqli_query($conn,"select * from `order` where order_status='1' and payment_status='1' group by order_id"); 
	          $total =0;
