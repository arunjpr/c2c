...
$Detials = mysqli_query($conn,"SELECT * FROM customer ");
//print_r($Detials);die;
?>
<!DOCTYPE html>
<html lang="en">
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Users</a> <a href="javascript:void(0);" class="current">Manage Users</a></div>
    <h1>Manage Users</h1>
  </div>
            ...
            <table class="table table-bordered data-table">
			  ...
			  while($Users = mysqli_fetch_array($Detials)){
                ...
                <tr class="gradeX<?=$Users['Id']?>">
                 ...
                 <td><a href="edit_users.php?id=<?=base64_encode($Users['Id']);?>"><span class="icon-edit"><span></a> &nbsp;&nbsp;
                
				  <a href="javascript:void(0);" onclick="Delete('<?php print $Users['Id'];?>','<?php print "Customer";?>')"><span class="icon-trash"><span></a></td>
                </tr>
