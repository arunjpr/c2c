                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-tag"></i></span>
                                <input type="text" name="License_Number" value="<?php echo $driver_data['License_Number']; ?>" class="form-control required" id="License_Number" placeholder="Enter license number">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <img src="<?php echo base_url() ?>/assets/backend/img/driver/dl/<?php echo $driver_data['Image'] ?>" style="width: 100px;height: 100px;">
...
<script type="text/javascript">
    ...
    document.forms['edit_form'].elements['vehicle_id'].value = '<?php echo $driver_data['vehicle_id'] ?>';
</script>