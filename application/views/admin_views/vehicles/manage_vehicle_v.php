                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <?php if($user_data['v_type_id']==1){?>
                                        <td><img src="<?php echo base_url() ?>/assets/backend/img/vehicle/byke/<?php echo $user_data['v_vehicle_Image'] ?>" style="width: 60px;height: 30px;"></td>
                                    <?php } elseif($user_data['v_type_id']==2) {?>
                                   
                                        <td><img src="<?php echo base_url() ?>/assets/backend/img/vehicle/auto/<?php echo $user_data['v_vehicle_Image'] ?>" style="width: 60px;height: 30px;"></td>
                                    <?php } elseif($user_data['v_type_id']==3) {?>
                                   
                                        <td><img src="<?php echo base_url() ?>/assets/backend/img/vehicle/electric_rickshaw/<?php echo $user_data['v_vehicle_Image'] ?>" style="width: 60px;height: 30px;"></td>
                                    <?php } ?>
