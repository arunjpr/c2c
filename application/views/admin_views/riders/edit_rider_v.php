...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-circle-o"></i> Edit Rider </li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Rider </h3>
        ...
        <!-- form start -->
        <form role="form" name="edit_form" action="<?php echo base_url('admin/rider/update_rider/' . $user_data['Id'] . ''); ?>" method="post" class="form-validation" >
