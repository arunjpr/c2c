...
<section class="content-header">
    <h1>
        Rider
        <small>Add Rider</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li> 
        <li><a href="<?php echo base_url('admin/rider'); ?>"><i class="fa fa-cogs"></i> Manage Riders</a></li>
        <li><a class="active"><i class="fa fa-cogs"></i> Add Rider</a></li>
    </ol>
</section>
...
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">Add Rider</h3>
        ...
        <!-- form start -->
        <form role="form" name="add_form" action="<?php echo base_url('admin/rider/create_rider'); ?>" method="post"  class="form-validation" >
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
...
<!--                     <div class="col-md-6">
            ...
            <div class="box-footer">
                <a href="<?php echo base_url('admin/rider'); ?>" class="btn btn-danger" data-toggle="tooltip" title="Go back"><i class="fa fa-remove"></i> Cancel</a>
